#
#  Be sure to run `pod spec lint DQExtensions.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.description  = <<-DESC
    DQExtensions adds several useful extensions and conveniences for managing `DispatchQueue` types in Grand Central Dispatch.
  ...
  spec.homepage     = "https://github.com/pokanop/dqe"
